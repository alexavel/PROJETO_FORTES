object Dm: TDm
  ...
  object GravaNotas: TFDQuery
    Connection = fdConexao
    SQL.Strings = (
      
        'insert into alunos_nota(nta_id, nta_iddcp, nta_idaln, nta_nota, ' +
        'nta_idtnt )'
      
        '               values ((Select Coalesce( max(nta_id),0)+1 From a' +
        'lunos_nota),:nta_iddcp, :nta_idaln, :nta_nota, :nta_idtnt)')
    Left = 592
    Top = 168
    ParamData = <
      item
